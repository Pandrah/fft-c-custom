...
Homemade cpp fft and ifft and filtering
...
```
cd existing_repo
git remote add origin https://git.enib.fr/a9mevel/fft-c.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.enib.fr/a9mevel/fft-c/-/settings/integrations)
...
The `c++` methods to create those files automatically is written in **prog.cpp** (such as the methods which prints the results on the command prompt)
